...
function initializeChatbot() {
    ...
    const botResponses = [
        ...
        { keywords: ['2sva'], response: "Here are the SVA links:<div class='chat-buttons'><a href='https://remarkable-medovik-76a46a.netlify.app/' target='_blank' class='chat-btn'><span class='chat-btn-icon purple'><i class='fas fa-globe'></i></span><span class='chat-btn-info'><span class='chat-btn-title'>2SVA Vehicle Manager</span><span class='chat-btn-desc'>Web application</span></span><i class='fas fa-arrow-right chat-btn-arrow'></i></a><a href='https://sva-jobs.web.app' target='_blank' class='chat-btn'><span class='chat-btn-icon blue'><i class='fas fa-briefcase'></i></span><span class='chat-btn-info'><span class='chat-btn-title'>2SVA Job Management System</span><span class='chat-btn-desc'>Web application</span></span><i class='fas fa-arrow-right chat-btn-arrow'></i></a><a href='https://monumental-tarsier-24d39a.netlify.app/' target='_blank' class='chat-btn'><span class='chat-btn-icon green'><i class='fas fa-link'></i></span><span class='chat-btn-info'><span class='chat-btn-title'>2SVA Petty Cash</span><span class='chat-btn-desc'>Web application</span></span><i class='fas fa-arrow-right chat-btn-arrow'></i></a></div>" }
    ];
